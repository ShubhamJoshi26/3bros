           ...
           ->addIndexColumn()
               ...
               <div class="buttons right nowrap">
                   <button class="button btn btn-success small green --jb-modal"  data-target="sample-modal-2" type="button">
                     <a style="color:black !important" href="'.url('/').'/admin/menu/edit/'.$row->menuid.'" title="edit">Edit</a>
                   </button>

                   <button class="button btn btn-danger small red --jb-modal" data-target="sample-modal" type="button">
                     <a onclick="return ConfirmDelete()" href="'.url('/').'/admin/menu/delete/'.$row->menuid.'" title="delete" style="color:black !important">Delete</a>
                   </button>
             </div>
             ';
     ...
     { 
         ...
         {     
                ...
                case "page": 
                    ...
                    if(!empty($data))
                    {
                     ...
                     <div class="form-group">
                                <div class="select">
                                <select  id="premalink" name="premalinkPage" class="select2 form-control">';
                ...
                default:  
                 ...
                 $output .= '<label class="form-label" >Custom Link/URL</label>';
                 $output .= '<input class="form-control"  name="premalinkPage" placeholder="Custom Premalink Page Link Add" value="" >';
