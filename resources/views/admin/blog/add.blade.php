...
<div class="page-wrapper">
    ...
    @include('admin.layout.alert')
        ...
        <div class="card">
      <div class="card-body">
            <form action="/admin/blog/create" id="addtestimonials" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-12 col-lg-6">
                  ...
                  value="<?php if(isset($blogs['created_at']) && $blogs['created_at']!=''){echo date('d-m-Y',strtotime($blogs['created_at']));}?>" placeholder="Blog Date" name="date">
                </div>
                <div class="col-12 col-lg-6">
