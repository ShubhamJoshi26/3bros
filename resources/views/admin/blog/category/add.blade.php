...
<div class="page-wrapper">
    ...
    @include('admin.layout.alert')
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Blog Category</li>
        ...
        <div class="card">
      <div class="card-body">
            <form action="/admin/blog/category/create" id="addtestimonials" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="col-12 col-lg-6">
                  ...
                  value="<?php if(isset($category) && $category['title']!=''){echo $category['title'];}?>" placeholder="Category Title" name="title">
                </div>
                <div class="col-12 col-lg-6">
