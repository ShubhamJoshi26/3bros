                        ...
                        <div class="topbar-right text-right">
                            ...
                            <div class="ttm-social-links-wrapper list-inline">
                                <ul class="social-icons">
                                    <li><a href="https://www.facebook.com/3brosz" target="_blank"><i
                                                class="fa fa-facebook"></i></a>
                                    </li>
                                    <li><a href="https://www.instagram.com/3brosz/" target="_blank"><i
                                                class="fa fa-instagram"></i></a>
                                    </li>
                                    <li><a href="https://www.youtube.com/channel/UCpvggau5fZmJc2E9KwbKP3Q/videos"
                                ...
                                <div class="site-header-main">
                                    ...
                                    <div id="site-navigation" class="site-navigation">
                                                ...
                                                <div class="ttm-search-overlay">
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="ttm-search-close"><i class="fa fa-close"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <nav id="menu" class="menu">
                                            {!!$frontmenu!!}
                                            <!-- <ul class="dropdown">
                                                <li class="active"><a href="#">Banquets & Farmhouse</a>
                                                    <ul>
                                                        <li><a href="#">Banquets In Noida
                                                            </a></li>
                                                        <li><a href="#">Banquets In Gaziabad
                                                            </a></li>
                                                        <li><a href="#">Banquets In East Delhi
                                                            </a></li>
                                                ...
                                                <li><a href="#">Plan your Party</a>
                                                    <ul>
                                                        <li><a href="#">First Birthday Party</a></li>
                                                        <li><a href="#"> Anniversary Party</a></li>
                                                        <li><a href="#">Ring ceremony Party</a></li>
                                                ...
                                                <li><a href="#">More</a>
                                                    <ul>
                                                        ...
                                                        <li class=""><a href="#">Candle Light Packages
                                                            </a>
                                                            <ul>
                                                                <li><a href="#">Coffee Package Rs 999</a></li>
                                                                <li><a href="#">Popular Candle Light
                                                                        Rs 1999</a></li>
                                                                <li><a href="#">Silver
                                                                        Candle Light
                                                                        Rs 2999</a>
                                                                </li>
                                                                <li><a href="#">Exclusive Gold Package
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class=""><a href="#">Buffet Menu

                                                            </a>
                                                            <ul>
                                                                <li><a href="#">Sizzler Buffet Menu</a></li>
                                                                <li><a href="#">Mahabharat Sizzler Menu</a></li>
                ...
                <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.3.0.2">
                    ...
                    <ul>
                        <li data-index="rs-1" data-transition="boxslide" data-slotamount="default"
                            ...
                            data-rotate="0" data-saveperformance="off" data-title="Let’s Have a Party!" data-param1=""
                            ...
                            <div class="tp-caption tp-resizeme highlight-skin-button" id="slide-1-layer-2"
                                ...
                                data-paddingleft="[18,18,18,18]">April 20th 2024</div>

                            <div class="tp-caption tp-resizeme tp-shapewrapper" id="slide-1-layer-3"
                                data-x="['center','center','center','center']" data-hoffset="['269','269','201','134']"
                            ...
                            <a class="tp-caption tp-resizeme highlight-skin-button" href="#" target="_self"
                                ...
                                data-hoffset="['-97','-97','-97','-97']" data-y="['middle','middle','middle','middle']"
                                data-voffset="['203','182','127','85']" data-fontsize="['14','14','14','14']"
                                ...
                                data-paddingbottom="[15,15,15,10]" data-paddingleft="[30,30,30,25]">Get A Quote </a>
                        ...
                        <li data-index="rs-2" data-transition="slotslide-vertical,fade"
                            ...
                            data-easein="default,default" data-easeout="default,default" data-masterspeed="default,300"
                            data-thumb="" data-delay="10010" data-rotate="0,0" data-saveperformance="off"
                            ...
                            ><div class="tp-caption tp-resizeme" id="slide-2-layer-4"
                                ...
                                data-visibility="['on','on','off','off']" data-type="shape" data-responsive_offset="on"
                            ...
                            <a class="tp-caption tp-resizeme vedio-icon"
                                href="https://youtu.be/xmmWaQO3yN4?si=tx2twM_dZtxp1x6U" target="_self"
                                id="slide-2-layer-5" data-x="['right','right','right','center']"
                            ...
                            <a class="tp-caption tp-resizeme highlight-skin-button" href="#" target="_self"
                                ...
                                data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[15,15,15,10]" data-paddingright="[30,30,30,25]"
                                data-paddingbottom="[15,15,15,10]" data-paddingleft="[30,30,30,25]">Get A Quote <span><i
                                        class="ti ti-angle-right"></i></span></a>
...
<!-- main container ends -->
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-4 ttm-footer2-right">
                            <div class="ttm-social-link-wrapper">
                                <ul class="social-icons">
                                    ...
                                    <li><a href="https://www.youtube.com/channel/UCpvggau5fZmJc2E9KwbKP3Q/videos?reload=9"
    ...
    <a href="https://api.whatsapp.com/send?phone=+91-072109-91313&amp;text=Hello," class="btn-whatsapp-pulse">
